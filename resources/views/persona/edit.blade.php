                ...
                <div class="card-body">
                    <form action="{{route('persona.update',$persona->id)}}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" name="fecha_nacimiento" class="form-control" value="{{$nacimiento}}">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="datetime-local" name="fecha_recepcion_muestra" class="form-control" value="{{$recepcion}}">
